...
// Tell routes which database to use: 'mongo' or 'file'
global.dbMode = 'file';
...
app.get('/api/health', (req, res) => {
  res.json({ status: 'ok', dbMode: global.dbMode, message: 'Royal Rumble API is running' });
});
...
async function startServer() {
  try {
    ...
    global.dbMode = 'file';
    fileDb.getWrestlers(); // creates db.json if missing
